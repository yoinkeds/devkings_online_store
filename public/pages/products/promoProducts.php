<div class="section-content">
  ...
  foreach($products as $products =>$product){
    ?> 
      <div class="product_card <?php if($product['p_status'] == "sales"){echo "hot-product";} ?>">
        <div class="card-header">
            <img class="chead-img" src="../assets/img/p_img/<?php if($product['product_image']){
              echo $product['product_image'];
              }else{
                echo 'sample';
              };?>.jpg" alt="Header Image">
        </div>
        <div class="card-body">
